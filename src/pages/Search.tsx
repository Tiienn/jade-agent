      ...
      {showEmptyState && (
        <div className="mt-16 flex flex-col items-center text-center">
          ...
          <p className="mt-1 max-w-sm text-sm text-gray-500">
            ...
            <span className="font-medium text-gray-700">AH tower plan</span> and
            press search.
          </p>
        </div>
      )}
...
function ResultRow({
  ...
  return (
    <li className="rounded-xl border border-gray-200 bg-white p-3 transition-colors hover:border-gray-300 sm:p-4">
      ...
      <div className="mt-3 flex gap-2">
        <button
          onClick={onPreview}
          className="inline-flex min-h-[44px] flex-1 items-center justify-center gap-1.5 rounded-lg border border-gray-300 bg-white px-3 text-sm font-medium text-gray-700 transition-colors hover:bg-gray-50 sm:flex-none"
        >
          <Eye size={16} />
          Preview
        </button>
        <button
          ...
          className="inline-flex min-h-[44px] flex-1 items-center justify-center gap-1.5 rounded-lg bg-jade-600 px-3 text-sm font-medium text-white transition-colors hover:bg-jade-700 disabled:opacity-60 sm:flex-none"
        >
          {downloading ? (
            <Loader2 size={16} className="animate-spin" />
          ) : (
